...
from crew_utils import Task, CrewGameState, DEFAULT_PARAMETERS, \
    THREE_PLAYER_PARAMETERS, deal_cards
...
def example_game(number: int | None):
    ...
    return CrewGame(parameters,
                    CrewGameState(hands, active_player, tasks, special_tasks))
