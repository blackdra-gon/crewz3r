...
def example_game(number: int | None = None) -> CrewGame:
    description: str = ""
...
def random_game_mission_26(
    parameters: CrewGameParameters = FIVE_PLAYER_PARAMETERS,
) -> CrewGame:
